...
public class ServerView extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((ToggleButton) findViewById(R.id.talkToggleButton)).setOnCheckedChangeListener(onTalkToggle);
    ...
    private CompoundButton.OnCheckedChangeListener onTalkToggle = new CompoundButton.OnCheckedChangeListener() {
        @Override
